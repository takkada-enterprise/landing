...
export const ALTERNATIVES = [
  {
    ...
    hero: {
      ...
      alt: 'A collected payment settling against the invoice it belongs to, ready to post into Tally',
      width: 904,
      height: 1874,
    },
    author: 'founder',
    ...
    walkthrough: [
      ...
      },
      {
        ...
        image: '/assets/screenshots/settlement.webp',
        alt: 'A payment matched against its outstanding invoice and posted as a receipt into Tally',
        width: 904,
        height: 1874,
      },
      {
...

  {
    ...
    walkthrough: [
      ...
      },
      {
        ...
        image: '/assets/screenshots/settlement.webp',
        alt: 'A receipt matched to its invoice and written back into Tally',
        width: 904,
        height: 1874,
      },
      {
