...
quotes:
  ...
  - "Edit Credit Note"
  - "Edit Debit Note"
  - "Creating credit note for"
  - "Creating debit note for"
  - "Credit Note No."
  - "Debit Note No."
  ...
  - "No ledger account selected"
  - "Tap below to select a ledger"
  - "Add Items"
  - "Add More Items"
  - "Modify Items"
  - "No items added"
  - "Tap below to add items from your inventory"
  - "Quantity"
  - "Rate"
  ...
  - "Ledger amount must be greater than 0"
  - "Total amount must be greater than 0"
  - "No Credit Notes Yet"
  - "No Debit Notes Yet"
  - "Search credit notes by customer"
  - "Search debit notes by supplier"
  - "This Month"
  - "Voucher creation is not enabled for this company."
quoteSources:
  "Credit Notes": [lib/screens/credit_note_register_screen.dart]
  "Debit Notes": [lib/screens/debit_note_register_screen.dart]
  "New Credit Note": [lib/screens/credit_note_register_screen.dart]
  "New Debit Note": [lib/screens/debit_note_register_screen.dart]
  "Credit Note": [lib/screens/party_details_screen.dart]
  "Debit Note": [lib/screens/party_details_screen.dart]
  "Create Credit Note": [lib/screens/create_credit_note_screen.dart]
  "Create Debit Note": [lib/screens/create_debit_note_screen.dart]
  "Edit Credit Note": [lib/screens/create_credit_note_screen.dart]
  "Edit Debit Note": [lib/screens/create_debit_note_screen.dart]
  "Creating credit note for": [lib/screens/create_credit_note_screen.dart]
  "Creating debit note for": [lib/screens/create_debit_note_screen.dart]
  "Credit Note No.": [lib/widgets/voucher/voucher_number_field.dart]
  "Debit Note No.": [lib/widgets/voucher/voucher_number_field.dart]
  "Against invoice (optional)": [lib/screens/create_credit_note_screen.dart]
  "Against invoice": [lib/screens/create_credit_note_screen.dart]
  ...
  "Particulars": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Items": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Select Ledger Account": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Selected Ledger Account": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "No ledger account selected": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Tap below to select a ledger": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Add Items": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Add More Items": [lib/screens/create_credit_note_screen.dart]
  "Modify Items": [lib/screens/create_debit_note_screen.dart]
  "No items added": [lib/screens/create_credit_note_screen.dart]
  "Tap below to add items from your inventory": [lib/screens/create_credit_note_screen.dart]
  "Quantity": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Rate": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Add tax and discount": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Add notes": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Total Amount": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Create credit note": [lib/widgets/voucher/create_voucher_bottom_bar.dart]
  "Create debit note": [lib/widgets/voucher/create_voucher_bottom_bar.dart]
  "Update credit note": [lib/widgets/voucher/create_voucher_bottom_bar.dart]
  "Update debit note": [lib/widgets/voucher/create_voucher_bottom_bar.dart]
  "Credit Note created": [lib/screens/create_credit_note_screen.dart]
  "Debit Note created": [lib/screens/create_debit_note_screen.dart]
  "Credit note updated successfully": [lib/screens/create_credit_note_screen.dart]
  "Debit note updated successfully": [lib/screens/create_debit_note_screen.dart]
  "Please add at least one item": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Please select a ledger account": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Ledger amount must be greater than 0": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "Total amount must be greater than 0": [lib/screens/create_credit_note_screen.dart, lib/screens/create_debit_note_screen.dart]
  "No Credit Notes Yet": [lib/screens/credit_note_register_screen.dart]
  "No Debit Notes Yet": [lib/screens/debit_note_register_screen.dart]
  "Search credit notes by customer": [lib/screens/credit_note_register_screen.dart]
  "Search debit notes by supplier": [lib/screens/debit_note_register_screen.dart]
  "This Month": [lib/screens/credit_note_register_screen.dart]
...
sections:
  - id: before-you-start
    ...
    settings: {}
    permission: credit-or-debit-note-create
  - id: which-note-do-you-need
    featureKeys: [voucher_creation_mobile]
    settings: {}
    permission: credit-or-debit-note-create
  - id: make-a-credit-note
    featureKeys: [voucher_creation_mobile]
    settings: {}
    permission: credit-notes-register-create
  - id: naming-the-original-bill
    featureKeys: [voucher_creation_mobile]
    settings: {}
    permission: credit-notes-register-create
  - id: make-a-debit-note
    featureKeys: [voucher_creation_mobile]
    settings: {}
    permission: debit-notes-register-create
...
- **Your GST ledger mapping must be finished**, since a note carries tax the same way a bill does. See [How to map your Tally ledgers](/guide/ledger-mapping).
...
- **You simply want to record money received or paid** → not a note at all. Use a receipt or a payment. See [How to record a receipt](/guide/record-receipt).
...
**The note saved but is not in Tally.** Saving and syncing are two steps. Open the Tally Sync screen for the real reason — see [How to check and fix Tally sync](/guide/tally-sync).
