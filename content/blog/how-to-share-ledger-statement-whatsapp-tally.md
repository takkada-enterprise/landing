...
meta_title: "Share Ledger Statement on WhatsApp From Tally: Guide"
...
1. Open Tally Prime on the office machine and load the company
2. Go to **Gateway of Tally**, then **Display More Reports**, then **Account Books**, then **Ledger**
3. Pick the party whose statement you want to send
4. Set the period (press **F2** and choose the date range, usually 1 April to today for the running year)
5. Press **Ctrl+E** to export, choose **PDF** as the format, and note the folder Tally saves it into
6. Open WhatsApp (Web on the same PC, or your phone), open the party's chat, tap attach, and pick the saved PDF
7. Type a one-line note ("Aapka ledger statement attached hai, ₹2,40,000 baaki hai") and send

That is the whole manual flow. It is reliable, and for a once-a-week reconciliation from the desk it is fine. The friction shows up when the request lands while you are on a route. You are now telling the party "office pahunch ke bhejta hoon", and the statement, and the payment behind it, both wait. For sending the underlying figures rather than the full ledger, the [party-wise outstanding statement in Tally](/blog/partywise-outstanding-statement-tally/) is the report that feeds most of these conversations.
...
1. Open the app on your phone and tap the party whose statement the retailer asked for
