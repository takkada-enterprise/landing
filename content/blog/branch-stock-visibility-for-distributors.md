...
meta_title: "Branch Stock Visibility for Distributors"
...
The plumbing behind the answer is described in [managing multiple branches in Tally with godowns](/blog/manage-multiple-branches-tally-godowns/).
...
The salesman wants one item. He is standing at a counter with a retailer asking about a specific SKU, and he needs to know whether it can ship today and from where. An item drill-down across locations answers him; a company-wide list does not, covered in [the godown-wise stock report on mobile](/blog/godown-wise-stock-report-tally-mobile/).

The storekeeper wants his own location, and he needs to record movement rather than only read it. He also should not be able to move stock out of somebody else's warehouse, which is what [warehouse-scoped staff access](/blog/restrict-staff-warehouse-access-tally/) is for.
