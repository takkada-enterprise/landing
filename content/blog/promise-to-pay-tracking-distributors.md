...
meta_title: "Promise to Pay Tracking for Distributors"
...
A retailer saying "kal bhej dunga" is not a plan until it has an amount and a day. Promise to pay tracking is how that sentence becomes both. You log the follow-up against the party, set the outcome to promised, fill the promised amount and the promised date, and set the next-action date to that same day. The [payment follow up log](/blog/customer-follow-up-log-for-collections/) is the notebook. The promise fields are the line that the morning can act on.

Tally already knows the bill. It does not know that Monday's call produced ₹45,000 for Tuesday against the oldest of three invoices. Without that date, Tuesday morning is the same printed outstanding list as Monday, and the chemist sits at row 40. With it, the [payment recovery dashboard](/blog/payment-recovery-dashboard-for-distributors/) names the promise as due today before the first retailer call.
...
[Days sales outstanding](/blog/days-sales-outstanding-distributor-india/) moving from 58 to 64 is a company number. Three promises proven missed this week, all on Ramesh's parties, is a Tuesday plan. The missed mark is how DSO becomes a conversation.
