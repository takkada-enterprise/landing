---
title: "How to Accept Online Payment on Tally Invoices"
slug: "accept-online-payment-on-tally-invoice"
meta_title: "Accept Payment on Tally Invoices Without MDR"
...
1. The invoice is raised in Tally, or on the phone, with the party and amount
2. The companion app generates a UPI payment link pre-filled with the exact invoice amount
3. The link goes to the retailer, usually on WhatsApp alongside the invoice itself
4. The retailer taps, their UPI app opens with the amount already filled, and they pay
5. The receipt, with its UTR, matches back to the invoice and posts a receipt voucher in Tally

The retailer never types an amount or an account number, so a ₹14,320 invoice gets paid in under a minute instead of "account number bhej do, kal kar dunga." Sending the invoice and the link together is its own small craft, covered in the piece on [auto-dispatching invoices on WhatsApp from Tally](/blog/tally-whatsapp-invoice-dispatch/).
...
Takkada lets distributors accept payment on Tally invoices over UPI at 0% MDR, with the receipt auto-matched and posted back into Tally as a clean voucher. [Book a free demo](https://calendar.notion.so/meet/ronakmalu/takkada).
