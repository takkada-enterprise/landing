...
meta_title: "Ledger Reconciliation in Tally for Distributors"
...
This is different from bank reconciliation, which matches your Tally against your bank statement. Party reconciliation matches your Tally against another business's books. The [bank statement reconciliation on mobile](/blog/how-to-reconcile-bank-statement-tally-mobile/) guide covers the bank side; this one is about the party side.
...
If comparing full statements is heavy, the [party-wise outstanding statement in Tally](/blog/partywise-outstanding-statement-tally/) gives a tighter bill-level list that carries most reconciliation conversations. And when you need to send your side across for the party to check, [sharing the ledger statement on WhatsApp from Tally](/blog/how-to-share-ledger-statement-whatsapp-tally/) puts it in their chat in a few taps.
...
This is why [bill-by-bill against reference](/blog/bill-by-bill-against-reference-tally/) matters beyond your own bookkeeping. A receipt tagged Against Reference to the exact bill it clears keeps your side reconciliation-ready, so when the party's statement arrives, the two line up entry for entry instead of forcing a lump-sum negotiation.
