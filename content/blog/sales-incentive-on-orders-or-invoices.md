...
meta_title: "Sales Incentive on Orders or Invoices"
meta_description: "Sales incentive on orders or invoices: when credit is given, what a cancellation does, and what a partial invoice does. Pick one basis and leave it."
primary_keyword: "sales incentive on orders or invoices"
date: "2026-08-26"
updated: "2026-08-26"
author: "founder"
category: "Comparisons"
excerpt: "Raju booked ₹9,20,000 in August and the office billed ₹6,40,000. Pay him on orders and he has crossed ₹8,00,000. Pay him on invoices and he is still ₹1,60,000 short. The receipt Gupta Stores sent does not sit on either pile."
---
...
Sales incentive on orders or invoices is the choice of which Tally register feeds the number you pay on. An order is a Sales Order. An invoice is a sale that has been billed. A receipt is neither. [Beat-wise sales management](/blog/beat-wise-sales-management-tally-distributors/) already puts the field order into Tally as a Sales Order. The office converts it the way it already does. Incentive follows whichever of those two you point at.

Team Sales, on the [Salesman app for Tally](/salesman-app-tally), carries that toggle. Period is Month, Quarter or Year. [Salesman targets and commission from Tally](/blog/salesman-targets-and-commission-from-tally/) is the screen around it. This post is the basis.
...
A cancelled order is still a Tally fact. Team Sales reads the register you pointed it at. [Salesman order taking without re-entry](/blog/salesman-order-to-tally-without-reentry/) is how the original ₹42,000 got there. Cancellation is the office doing what it already does in Tally. The basis decides whether Raju had been paid on that rupee yet.
...
Set it when you set the targets. [Salesman targets and commission from Tally](/blog/salesman-targets-and-commission-from-tally/) already has Raju at ₹8,00,000 for August. If that ₹8,00,000 is an orders target, the toggle is Orders for the whole month. If it is an invoices target, the toggle is Invoices. Changing it on the 20th, after Raju has ₹9,20,000 of orders and ₹6,40,000 of bills, is how a crossed target becomes a short target without anyone's market changing.
...
[Who gets credit for the order](/blog/order-attribution-and-reassignment-salesman/) can still move a sale from Manoj to Raju after a covering day. Reassignment does not change the basis. It changes the name. Tally is not touched. The ₹18,000 Manoj booked on Station Road becomes Raju's on whichever register you are already reading.

Stick to it means the five men can recite the rule. "Order pe milta hai" or "bill pe milta hai." One sentence. The leaderboard then stops being a debate. A [salesman-wise sales report](/blog/salesman-wise-sales-report-tally/) from the register still sits beside that, the same Tally sales, without a second spreadsheet.
...
[What field teams actually need from a Tally app in India](/blog/salesman-app-tally-india/) is still the order into the books. The incentive argument is only which of those two sales documents you pay on. Pick one. Leave it for the period. Read the leaderboard at 8 PM without a second spreadsheet.
