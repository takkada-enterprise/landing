---
title: "Track Supplier Lead Time from Your Own Purchase Register"
slug: "supplier-lead-time-tracking-for-distributors"
meta_title: "Supplier Lead Time Tracking from Purchases"
meta_description: "Supplier lead time tracking means days from order to receipt, read off your purchase register. Keep the median and the worst case, not the average."
primary_keyword: "supplier lead time tracking"
date: "2026-08-26"
updated: "2026-08-26"
author: "founder"
category: "How-To"
excerpt: "Kolkata oil was 'about a week' until the purchase register showed 6, 7, 8, 8, 11, 14. Median 8, worst case 14. The 14-day rain week is the one that empties the godown."
---
...
This number is the one Tally will not store against the stock item. It is also the one the [reorder point formula](/blog/reorder-point-formula-for-distributors/) cannot run without. Average daily sales times a guessed week is a guessed purchase.
...
Receipt date is the easy one. The purchase voucher, or the goods receipt note if you book one, has a date. That is the day quantity entered the location. [Stock Summary](/blog/stock-summary-report-tally-mobile/) will show the inward on that date if you drill the item. The voucher is the source.
...
Days of cover is quantity on hand divided by average daily sales. On the oil, 96 ÷ 24 = 4. Lead time median is 8. Cover is already below lead time. The purchase is today, which is the same conclusion the [reorder point](/blog/reorder-point-formula-for-distributors/) gave with a 3-day buffer.
...
This is the lead-time half of [stockout control for distributors](/blog/stockout-control-for-distributors-india/). The sales side comes from live reports. The days come from your own receipts. Tally does not raise a hand when cover crosses lead time. The owner still opens the two numbers.
