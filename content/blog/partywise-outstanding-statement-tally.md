---
title: "Partywise Outstanding Statement in Tally: Format, WhatsApp Dispatch, Auto-Reminders"
slug: "partywise-outstanding-statement-tally"
meta_title: "Partywise Outstanding Statement in Tally for Distributors"
...
- Automating the partywise outstanding statement from Tally to WhatsApp at 7-day, 15-day, and 30-day intervals lifts [collection efficiency](/blog/collection-efficiency-ratio-formula-india/) by 5–10 percentage points
...
1. **Gateway of Tally → Display More Reports → Statements of Accounts → Outstandings → Ledger** (or party-wise)
2. Pick the retailer's ledger
3. Filter by status (Open/All) and by aging (any/buckets)
4. Tally renders the statement on screen
5. Press **Alt+E** to export, usually as PDF or Excel
...
> Pay ₹55,600 in one tap: [UPI link]
> Or pay invoice-wise:
> INV-1218 (₹18,420): [link]
> INV-1247 (₹14,320): [link]
...
At [0% MDR](/blog/zero-mdr-upi-collection-for-distributors-india/), the distributor pays nothing per transaction. The retailer pays the exact invoice amount. The full amount lands in the distributor's bank in seconds. The receipt syncs back into Tally automatically, and the partywise outstanding statement updates to reflect the new balance.
...
A: An [outstanding statement](/blog/aging-report-tally/) is a single retailer's open invoices. An aging report is the distributor's whole receivables book bucketed by age (0–30, 31–60, 61–90, 90+ days). The partywise outstanding statement is what you send to the retailer; the aging report is what you read on your own dashboard.
...
Takkada generates the partywise outstanding statement from Tally and dispatches it to WhatsApp on a 7/15/30-day cadence, with 0% MDR UPI links per invoice. [Book a free demo](https://calendar.notion.so/meet/ronakmalu/takkada).
